...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root {\n  --background: #fff;\n  /* --background2: ;\n--background3: ; */\n  --accent: rgb(249 251 228);\n  /* --accent2: ;\n--accent3: ; */\n\n  --font: #000;\n  --font2: rgb(58, 110, 255);\n  --font3: #fff;\n  box-sizing: border-box;\n}\n\nbody {\n  font-family: Arial, Helvetica, sans-serif;\n  display: grid;\n  grid-template-areas:\n    \"header header\"\n    \"nav main\"\n    \"footer footer\";\n  margin: 0;\n  grid-template-rows: 4rem 1fr;\n  grid-template-columns: auto 1fr;\n  font-size: 1.125;\n  height: 100vh;\n  }\n\n.header {\n  grid-area: header;\n  background-color: rgb(255 235 108);\n  padding: 0.5rem;  \n  display: flex;\n  align-items: center;\n}\n\n.header img {\n  height: 2rem;\n  margin-right: 0.25rem;\n}\n.header div {\n  font-size: 1.8rem;\n  font-weight: bold;\n  font-family: 'Yatra One', cursive;\n}\n/* navigation */\n\n.navigation {\n  grid-area: nav;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  background-color: rgb(249 251 228);\n  width: fit-content;\n  padding: 0.5rem 1.5rem 0.5rem 0.5rem;\n}\n\n.views-nav-label,\n.projects-nav-label {\n  margin-top: 0.625rem;\n  margin-bottom: 0.5rem;\n  font-weight: bold;\n  font-style: italic;\n  font-size: 1.25rem;\n}\n\n.navigation img {\n  width: 1rem;\n  margin-right: 0.5rem;\n}\n\n.navigation span {\n  font-size: 1.188rem;\n}\n\n.navigation span:hover {\n  color: orange;\n  cursor: pointer;\n}\n\n.navigation span:active {\n  color: red;\n  cursor: pointer;\n}\n\n.footer {\n  font-size: 0.875rem;\n}\n\n.footer a, \n.footer a:visited {\n  color: black;\n}\n\n.footer a:hover {\n  color: orange;\n}\n\n.footer a:active {\n  color: red;\n}\n\n/* modal window */\n\ninput {\n  width: 200px;\n  height: 25px;\n}\n\ninput:invalid {\n  border: 1px red solid;\n}\n\nbutton {\n  width: 200px;\n}\n\n.add-button {\n  border-radius: 50%;\n  border: none;\n  width: 50px;\n  height: 50px;\n  background-color: rgb(255 235 108);\n  margin: 20px 5px;\n  font-weight: bold;\n  font-size: 2rem;\n  box-shadow: 3px 3px 3px #6c6767;\n  transition: background-color 300ms ease-in-out;\n  cursor: pointer;\n}\n\n.add-button:hover {\n  background-color: orange;\n}\n\n.add-button:active {\n  background-color: red;\n}\n\n.modal {\n  display: none;\n  position: fixed;\n  z-index: 1;\n  left: 30%;\n  top: 10%;\n  padding: 20px 30px;\n  background-color: rgb(249 251 228);;\n  box-shadow: 5px 5px 5px #6c6767;\n}\n\n.modal-top {\n  grid-column: 1 / 3;\n  display: grid;\n  justify-content: space-between;\n  grid-template-columns: 1fr 1fr;\n}\n\n.modal-top-left {\n  display: grid;\n  grid-template-columns: 1fr 1fr;\n  border: 1px white solid;\n  padding: 5px;\n}\n\n.modal-proj-label {\n  padding: 5px;\n  transition: background-color 300ms ease-in-out;\n}\n\n.modal-label {\n  margin-top: 3px;\n  margin-bottom: 3px;\n  padding: 5px;\n  grid-column: 1 / 2;\n  grid-row: 1 / 2;\n}\n\n.modal-label-active {\n  font-weight: bold;\n  background-color: rgb(255 235 108);\n}\n\n.modal-label-inactive {\n  background-color: rgba(255, 235, 108, 0.45);\n}\n\n.modal-label-inactive:hover {\n  background-color: orange;\n  cursor: pointer;\n}\n\n#form {  \n  display: grid;\n  grid-column: 1 / 3;\n  grid-template-columns: 1fr 1fr;\n  column-gap: 2rem;\n}\n\n#form div {\n  display: grid;\n}\n\n#description, #notes {\n  width: 200px;\n  height: 100px;\n}\n\n.close-btn {\n  grid-column: 3 / 4;\n  grid-row: 1 / 2;\n  height: 20px;\n  width: 20px;\n  background-color: rgb(255 235 108);\n  padding: 0px;\n  border: none;\n  font-weight: bold;\n  transition: background-color 300ms ease-in-out;\n  box-shadow: 3px 3px 3px #6c6767;\n}\n\n.submit-button {\n  margin: 0 auto;\n  margin-top: 8px;\n  margin-bottom: 8px;\n  grid-column: 1 / 3;\n  background-color: rgb(255 235 108);\n  border: none;\n  transition: background-color 300ms ease-in-out;\n  box-shadow: 3px 3px 3px #6c6767;\n  cursor: pointer\n}\n\n.close-btn:hover, \n.submit-button:hover {\n  background-color: orange;\n}\n\n#project-form {\n  grid-template-columns: 1fr 1fr;\n  grid-template-rows: 1fr 1fr 1fr;\n  width: 534px;\n}\n\n#newProjectName {\n  grid-row: 2 / 3;\n  margin-bottom: 8px;\n}\n\n/* main - list of tasks */\n\n.main {\n  grid-area: main;\n  margin-left: 2rem;\n}\n\n.container-menu {\n  display: flex;\n  align-items: center;\n}\n\n.project-edit {\n  height: 1.2rem;\n  padding: 5px;\n  transition: background-color 300ms ease-in-out;\n}\n.project-edit:hover {\n  cursor: pointer;\n  background-color: orange;\n}\n\n.project-delete {\n  height: 1.2rem;\n  padding: 5px;\n  transition: background-color 300ms ease-in-out;\n}\n\n.project-delete:hover {\n  cursor: pointer;\n  background-color: orange;\n}\n\n.tablelabel {\n  margin: 1rem 0.5rem 1rem 0;\n  font-size: 1.2rem;\n  font-weight: bold;\n  text-decoration: underline;\n}\n\n.container {\n  width: 80%;\n  min-width: fit-content;\n}\n\n.task-row {\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  justify-content: space-between;\n  background-color: rgb(249 251 228);\n}\n\n.left-right {\n  display: flex;\n  align-items: center;\n}\n\n.task-check {\n  width: 1.1rem;\n  height: 1.1rem;\n  padding: 5px;\n}\n\n.task-check:hover {\n  background-color: orange;\n  cursor: pointer;\n}\n\n.task-date {\n  padding: 5px 5px 10px 5px;\n}\n\n.task-title {\n  padding: 5px;\n  font-weight: bold;\n  cursor: pointer;\n  transition: background-color 200ms ease-in-out;\n}\n\n.task-title:hover {\n  background-color: orange;\n}\n\n.task-done {\n  text-decoration: line-through;\n}\n\n.task-priority-div {\n  padding: 3px 8px;\n} \n.task-priority {\n  padding: 5px;\n  font-weight: bold;\n  font-size: 0.8rem;\n  text-transform: uppercase;\n}\n\n.task-priority-high {\n  color: red;\n  border: 2px solid red;\n  border-radius: 10px;\n}\n\n.task-priority-medium {\n  color: orange;\n  border: 2px solid orange;\n  border-radius: 10px;\n}\n\n.task-priority-low {\n  color: green;\n  border: 2px solid green;\n  border-radius: 10px;\n}\n\n.task-edit img,\n.task-delete img {\n  height: 1.2rem;\n  padding: 5px;\n  transition: background-color 300ms ease-in-out;\n}\n\n.task-edit img:hover,\n.task-delete img:hover {\n  cursor: pointer;\n  background-color: orange;\n}\n\n.details-row {\n  display: grid;\n  grid-template-columns: 1fr 1fr;\n  margin: 5px;\n  padding: 5px;\n  background-color: rgb(255 255 249);\n  row-gap: 0.8rem;\n}\n\n.details-row-hidden {\n  display: none;\n}\n", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAEA;EACE,kBAAkB;EAClB;kBACgB;EAChB,0BAA0B;EAC1B;cACY;;EAEZ,YAAY;EACZ,0BAA0B;EAC1B,aAAa;EACb,sBAAsB;AACxB;;AAEA;EACE,yCAAyC;EACzC,aAAa;EACb;;;mBAGiB;EACjB,SAAS;EACT,4BAA4B;EAC5B,+BAA+B;EAC/B,gBAAgB;EAChB,aAAa;EACb;;AAEF;EACE,iBAAiB;EACjB,kCAAkC;EAClC,eAAe;EACf,aAAa;EACb,mBAAmB;AACrB;;AAEA;EACE,YAAY;EACZ,qBAAqB;AACvB;AACA;EACE,iBAAiB;EACjB,iBAAiB;EACjB,iCAAiC;AACnC;AACA,eAAe;;AAEf;EACE,cAAc;EACd,aAAa;EACb,sBAAsB;EACtB,8BAA8B;EAC9B,kCAAkC;EAClC,kBAAkB;EAClB,oCAAoC;AACtC;;AAEA;;EAEE,oBAAoB;EACpB,qBAAqB;EACrB,iBAAiB;EACjB,kBAAkB;EAClB,kBAAkB;AACpB;;AAEA;EACE,WAAW;EACX,oBAAoB;AACtB;;AAEA;EACE,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,eAAe;AACjB;;AAEA;EACE,UAAU;EACV,eAAe;AACjB;;AAEA;EACE,mBAAmB;AACrB;;AAEA;;EAEE,YAAY;AACd;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,UAAU;AACZ;;AAEA,iBAAiB;;AAEjB;EACE,YAAY;EACZ,YAAY;AACd;;AAEA;EACE,qBAAqB;AACvB;;AAEA;EACE,YAAY;AACd;;AAEA;EACE,kBAAkB;EAClB,YAAY;EACZ,WAAW;EACX,YAAY;EACZ,kCAAkC;EAClC,gBAAgB;EAChB,iBAAiB;EACjB,eAAe;EACf,+BAA+B;EAC/B,8CAA8C;EAC9C,eAAe;AACjB;;AAEA;EACE,wBAAwB;AAC1B;;AAEA;EACE,qBAAqB;AACvB;;AAEA;EACE,aAAa;EACb,eAAe;EACf,UAAU;EACV,SAAS;EACT,QAAQ;EACR,kBAAkB;EAClB,kCAAkC;EAClC,+BAA+B;AACjC;;AAEA;EACE,kBAAkB;EAClB,aAAa;EACb,8BAA8B;EAC9B,8BAA8B;AAChC;;AAEA;EACE,aAAa;EACb,8BAA8B;EAC9B,uBAAuB;EACvB,YAAY;AACd;;AAEA;EACE,YAAY;EACZ,8CAA8C;AAChD;;AAEA;EACE,eAAe;EACf,kBAAkB;EAClB,YAAY;EACZ,kBAAkB;EAClB,eAAe;AACjB;;AAEA;EACE,iBAAiB;EACjB,kCAAkC;AACpC;;AAEA;EACE,2CAA2C;AAC7C;;AAEA;EACE,wBAAwB;EACxB,eAAe;AACjB;;AAEA;EACE,aAAa;EACb,kBAAkB;EAClB,8BAA8B;EAC9B,gBAAgB;AAClB;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,YAAY;EACZ,aAAa;AACf;;AAEA;EACE,kBAAkB;EAClB,eAAe;EACf,YAAY;EACZ,WAAW;EACX,kCAAkC;EAClC,YAAY;EACZ,YAAY;EACZ,iBAAiB;EACjB,8CAA8C;EAC9C,+BAA+B;AACjC;;AAEA;EACE,cAAc;EACd,eAAe;EACf,kBAAkB;EAClB,kBAAkB;EAClB,kCAAkC;EAClC,YAAY;EACZ,8CAA8C;EAC9C,+BAA+B;EAC/B;AACF;;AAEA;;EAEE,wBAAwB;AAC1B;;AAEA;EACE,8BAA8B;EAC9B,+BAA+B;EAC/B,YAAY;AACd;;AAEA;EACE,eAAe;EACf,kBAAkB;AACpB;;AAEA,yBAAyB;;AAEzB;EACE,eAAe;EACf,iBAAiB;AACnB;;AAEA;EACE,aAAa;EACb,mBAAmB;AACrB;;AAEA;EACE,cAAc;EACd,YAAY;EACZ,8CAA8C;AAChD;AACA;EACE,eAAe;EACf,wBAAwB;AAC1B;;AAEA;EACE,cAAc;EACd,YAAY;EACZ,8CAA8C;AAChD;;AAEA;EACE,eAAe;EACf,wBAAwB;AAC1B;;AAEA;EACE,0BAA0B;EAC1B,iBAAiB;EACjB,iBAAiB;EACjB,0BAA0B;AAC5B;;AAEA;EACE,UAAU;EACV,sBAAsB;AACxB;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,mBAAmB;EACnB,8BAA8B;EAC9B,kCAAkC;AACpC;;AAEA;EACE,aAAa;EACb,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,cAAc;EACd,YAAY;AACd;;AAEA;EACE,wBAAwB;EACxB,eAAe;AACjB;;AAEA;EACE,yBAAyB;AAC3B;;AAEA;EACE,YAAY;EACZ,iBAAiB;EACjB,eAAe;EACf,8CAA8C;AAChD;;AAEA;EACE,wBAAwB;AAC1B;;AAEA;EACE,6BAA6B;AAC/B;;AAEA;EACE,gBAAgB;AAClB;AACA;EACE,YAAY;EACZ,iBAAiB;EACjB,iBAAiB;EACjB,yBAAyB;AAC3B;;AAEA;EACE,UAAU;EACV,qBAAqB;EACrB,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,wBAAwB;EACxB,mBAAmB;AACrB;;AAEA;EACE,YAAY;EACZ,uBAAuB;EACvB,mBAAmB;AACrB;;AAEA;;EAEE,cAAc;EACd,YAAY;EACZ,8CAA8C;AAChD;;AAEA;;EAEE,eAAe;EACf,wBAAwB;AAC1B;;AAEA;EACE,aAAa;EACb,8BAA8B;EAC9B,WAAW;EACX,YAAY;EACZ,kCAAkC;EAClC,eAAe;AACjB;;AAEA;EACE,aAAa;AACf","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Yatra+One&display=swap');\n\n:root {\n  --background: #fff;\n  /* --background2: ;\n--background3: ; */\n  --accent: rgb(249 251 228);\n  /* --accent2: ;\n--accent3: ; */\n\n  --font: #000;\n  --font2: rgb(58, 110, 255);\n  --font3: #fff;\n  box-sizing: border-box;\n}\n\nbody {\n  font-family: Arial, Helvetica, sans-serif;\n  display: grid;\n  grid-template-areas:\n    \"header header\"\n    \"nav main\"\n    \"footer footer\";\n  margin: 0;\n  grid-template-rows: 4rem 1fr;\n  grid-template-columns: auto 1fr;\n  font-size: 1.125;\n  height: 100vh;\n  }\n\n.header {\n  grid-area: header;\n  background-color: rgb(255 235 108);\n  padding: 0.5rem;  \n  display: flex;\n  align-items: center;\n}\n\n.header img {\n  height: 2rem;\n  margin-right: 0.25rem;\n}\n.header div {\n  font-size: 1.8rem;\n  font-weight: bold;\n  font-family: 'Yatra One', cursive;\n}\n/* navigation */\n\n.navigation {\n  grid-area: nav;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  background-color: rgb(249 251 228);\n  width: fit-content;\n  padding: 0.5rem 1.5rem 0.5rem 0.5rem;\n}\n\n.views-nav-label,\n.projects-nav-label {\n  margin-top: 0.625rem;\n  margin-bottom: 0.5rem;\n  font-weight: bold;\n  font-style: italic;\n  font-size: 1.25rem;\n}\n\n.navigation img {\n  width: 1rem;\n  margin-right: 0.5rem;\n}\n\n.navigation span {\n  font-size: 1.188rem;\n}\n\n.navigation span:hover {\n  color: orange;\n  cursor: pointer;\n}\n\n.navigation span:active {\n  color: red;\n  cursor: pointer;\n}\n\n.footer {\n  font-size: 0.875rem;\n}\n\n.footer a, \n.footer a:visited {\n  color: black;\n}\n\n.footer a:hover {\n  color: orange;\n}\n\n.footer a:active {\n  color: red;\n}\n\n/* modal window */\n\ninput {\n  width: 200px;\n  height: 25px;\n}\n\ninput:invalid {\n  border: 1px red solid;\n}\n\nbutton {\n  width: 200px;\n}\n\n.add-button {\n  border-radius: 50%;\n  border: none;\n  width: 50px;\n  height: 50px;\n  background-color: rgb(255 235 108);\n  margin: 20px 5px;\n  font-weight: bold;\n  font-size: 2rem;\n  box-shadow: 3px 3px 3px #6c6767;\n  transition: background-color 300ms ease-in-out;\n  cursor: pointer;\n}\n\n.add-button:hover {\n  background-color: orange;\n}\n\n.add-button:active {\n  background-color: red;\n}\n\n.modal {\n  display: none;\n  position: fixed;\n  z-index: 1;\n  left: 30%;\n  top: 10%;\n  padding: 20px 30px;\n  background-color: rgb(249 251 228);;\n  box-shadow: 5px 5px 5px #6c6767;\n}\n\n.modal-top {\n  grid-column: 1 / 3;\n  display: grid;\n  justify-content: space-between;\n  grid-template-columns: 1fr 1fr;\n}\n\n.modal-top-left {\n  display: grid;\n  grid-template-columns: 1fr 1fr;\n  border: 1px white solid;\n  padding: 5px;\n}\n\n.modal-proj-label {\n  padding: 5px;\n  transition: background-color 300ms ease-in-out;\n}\n\n.modal-label {\n  margin-top: 3px;\n  margin-bottom: 3px;\n  padding: 5px;\n  grid-column: 1 / 2;\n  grid-row: 1 / 2;\n}\n\n.modal-label-active {\n  font-weight: bold;\n  background-color: rgb(255 235 108);\n}\n\n.modal-label-inactive {\n  background-color: rgba(255, 235, 108, 0.45);\n}\n\n.modal-label-inactive:hover {\n  background-color: orange;\n  cursor: pointer;\n}\n\n#form {  \n  display: grid;\n  grid-column: 1 / 3;\n  grid-template-columns: 1fr 1fr;\n  column-gap: 2rem;\n}\n\n#form div {\n  display: grid;\n}\n\n#description, #notes {\n  width: 200px;\n  height: 100px;\n}\n\n.close-btn {\n  grid-column: 3 / 4;\n  grid-row: 1 / 2;\n  height: 20px;\n  width: 20px;\n  background-color: rgb(255 235 108);\n  padding: 0px;\n  border: none;\n  font-weight: bold;\n  transition: background-color 300ms ease-in-out;\n  box-shadow: 3px 3px 3px #6c6767;\n}\n\n.submit-button {\n  margin: 0 auto;\n  margin-top: 8px;\n  margin-bottom: 8px;\n  grid-column: 1 / 3;\n  background-color: rgb(255 235 108);\n  border: none;\n  transition: background-color 300ms ease-in-out;\n  box-shadow: 3px 3px 3px #6c6767;\n  cursor: pointer\n}\n\n.close-btn:hover, \n.submit-button:hover {\n  background-color: orange;\n}\n\n#project-form {\n  grid-template-columns: 1fr 1fr;\n  grid-template-rows: 1fr 1fr 1fr;\n  width: 534px;\n}\n\n#newProjectName {\n  grid-row: 2 / 3;\n  margin-bottom: 8px;\n}\n\n/* main - list of tasks */\n\n.main {\n  grid-area: main;\n  margin-left: 2rem;\n}\n\n.container-menu {\n  display: flex;\n  align-items: center;\n}\n\n.project-edit {\n  height: 1.2rem;\n  padding: 5px;\n  transition: background-color 300ms ease-in-out;\n}\n.project-edit:hover {\n  cursor: pointer;\n  background-color: orange;\n}\n\n.project-delete {\n  height: 1.2rem;\n  padding: 5px;\n  transition: background-color 300ms ease-in-out;\n}\n\n.project-delete:hover {\n  cursor: pointer;\n  background-color: orange;\n}\n\n.tablelabel {\n  margin: 1rem 0.5rem 1rem 0;\n  font-size: 1.2rem;\n  font-weight: bold;\n  text-decoration: underline;\n}\n\n.container {\n  width: 80%;\n  min-width: fit-content;\n}\n\n.task-row {\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  justify-content: space-between;\n  background-color: rgb(249 251 228);\n}\n\n.left-right {\n  display: flex;\n  align-items: center;\n}\n\n.task-check {\n  width: 1.1rem;\n  height: 1.1rem;\n  padding: 5px;\n}\n\n.task-check:hover {\n  background-color: orange;\n  cursor: pointer;\n}\n\n.task-date {\n  padding: 5px 5px 10px 5px;\n}\n\n.task-title {\n  padding: 5px;\n  font-weight: bold;\n  cursor: pointer;\n  transition: background-color 200ms ease-in-out;\n}\n\n.task-title:hover {\n  background-color: orange;\n}\n\n.task-done {\n  text-decoration: line-through;\n}\n\n.task-priority-div {\n  padding: 3px 8px;\n} \n.task-priority {\n  padding: 5px;\n  font-weight: bold;\n  font-size: 0.8rem;\n  text-transform: uppercase;\n}\n\n.task-priority-high {\n  color: red;\n  border: 2px solid red;\n  border-radius: 10px;\n}\n\n.task-priority-medium {\n  color: orange;\n  border: 2px solid orange;\n  border-radius: 10px;\n}\n\n.task-priority-low {\n  color: green;\n  border: 2px solid green;\n  border-radius: 10px;\n}\n\n.task-edit img,\n.task-delete img {\n  height: 1.2rem;\n  padding: 5px;\n  transition: background-color 300ms ease-in-out;\n}\n\n.task-edit img:hover,\n.task-delete img:hover {\n  cursor: pointer;\n  background-color: orange;\n}\n\n.details-row {\n  display: grid;\n  grid-template-columns: 1fr 1fr;\n  margin: 5px;\n  padding: 5px;\n  background-color: rgb(255 255 249);\n  row-gap: 0.8rem;\n}\n\n.details-row-hidden {\n  display: none;\n}\n"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _tasks_all_svg__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./tasks_all.svg */ "./src/tasks_all.svg");
/* harmony import */ var _tasks_done_svg__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./tasks_done.svg */ "./src/tasks_done.svg");
/* harmony import */ var _tasks_open_svg__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./tasks_open.svg */ "./src/tasks_open.svg");
/* harmony import */ var _projects_icon_svg__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./projects_icon.svg */ "./src/projects_icon.svg");
/* harmony import */ var _done_png__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./done.png */ "./src/done.png");
...
function createModal() {
  ...
  submitBtn.addEventListener("click", (event) => {
    ...
    if (editedTask == null) {
      (0,___WEBPACK_IMPORTED_MODULE_0__.addTask)();
    } else {
      editTask();
    }
  (0,___WEBPACK_IMPORTED_MODULE_0__.checkTasks)();
  renderTasks(currentView);
  closeModal();
  ...
  (0,___WEBPACK_IMPORTED_MODULE_0__.addProject)();
  renderProjNav();
  closeModal();
  event.preventDefault();
  });
...
function renderEmptyTask() {
  ...
  dueDate.value = (0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])(new Date(), "yyyy-MM-dd");
}

function renderEditedTask(id) {
    let taskID = id;
    let searchedTask = ___WEBPACK_IMPORTED_MODULE_0__.allTasks.find((task) => task._id == taskID);
...
// edit task  
function editTask() {
  console.log(___WEBPACK_IMPORTED_MODULE_0__.allTasks);
...
function deleteTask(taskID) {
  let searchedTaskID = ___WEBPACK_IMPORTED_MODULE_0__.allTasks.findIndex((item) => item._id == taskID);
  ___WEBPACK_IMPORTED_MODULE_0__.allTasks.splice(searchedTaskID, 1);
  (0,___WEBPACK_IMPORTED_MODULE_0__.checkTasks)();
  renderTasks("open");
}
...
function createHeader() {
  ...
  logo.src = _done_png__WEBPACK_IMPORTED_MODULE_7__;
...
function createNav() {
  ...
  tasksAllIcon.src = _tasks_all_svg__WEBPACK_IMPORTED_MODULE_3__;
  const tasksOpenIcon = new Image();
  tasksOpenIcon.src = _tasks_open_svg__WEBPACK_IMPORTED_MODULE_5__;
  const tasksDoneIcon = new Image();
  tasksDoneIcon.src = _tasks_done_svg__WEBPACK_IMPORTED_MODULE_4__;
...
function renderTasks(tasklist) {
  ...
  if (tasklist === "open") {
    ...
    list = ___WEBPACK_IMPORTED_MODULE_0__.allTasks.filter((task) => task.done === "false" || task.done === false);
  } else if (tasklist === "finished") {
    containerLabel.textContent = "Finished tasks";
    list = ___WEBPACK_IMPORTED_MODULE_0__.allTasks.filter((task) => task.done === "true" || task.done === true);
  } else if (tasklist === "all") {
    containerLabel.textContent = "All tasks";
    list = ___WEBPACK_IMPORTED_MODULE_0__.allTasks;
  } else {
    //rendering list of tasks for a project
    containerLabel.textContent = tasklist;
    list = ___WEBPACK_IMPORTED_MODULE_0__.allTasks.filter((task) => task.project == tasklist);
    const containerButtons = document.createElement("div");
    const deleteImg = new Image();
    deleteImg.src = _delete_icon_svg__WEBPACK_IMPORTED_MODULE_2__;
  ...
  list.forEach((item) => {
    ...
    //human-readable date
    let humanDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])(new Date(item.dueDate), "dd MMM");
...
function renderProjNav() {
  ...
  projectsIcon.src = _projects_icon_svg__WEBPACK_IMPORTED_MODULE_6__;
  ...
  for (let i = 0; i < ___WEBPACK_IMPORTED_MODULE_0__.projects.length; i++) {
    ...
    let listName = `${___WEBPACK_IMPORTED_MODULE_0__.projects[i].name}`;
    ...
    projS.textContent = `${___WEBPACK_IMPORTED_MODULE_0__.projects[i].name}`;
...
All tasks belonging to this project will be assigned to the Default project.`) == true) {
      let searchedProject = ___WEBPACK_IMPORTED_MODULE_0__.projects.findIndex((project) => project.name == projectName);
      ___WEBPACK_IMPORTED_MODULE_0__.projects.splice(searchedProject, 1);

      let list = ___WEBPACK_IMPORTED_MODULE_0__.allTasks.filter((task) => task.project == projectName);
      list.forEach((task) => {
...
module.exports = __webpack_require__.p + "62e7d0287e76f69301b4.png";
...
module.exports = __webpack_require__.p + "003ae5cf4bf1c8007b41.svg";
...
module.exports = __webpack_require__.p + "83ae2c478f96052a1352.svg";
...
module.exports = __webpack_require__.p + "e0485d797ecfb37c5d1a.svg";
