...
function editTask() {
  ...
  editedTask = null;
  (0,___WEBPACK_IMPORTED_MODULE_0__.setStorageProjects)();
  (0,___WEBPACK_IMPORTED_MODULE_0__.setStorageTasks)();  
}
...
function renderProjNav() {
  ...
  for (let i = 0; i < ___WEBPACK_IMPORTED_MODULE_0__.projects.length; i++) {
    ...
    let listName = `${___WEBPACK_IMPORTED_MODULE_0__.projects[i]._name}`;
    ...
    projS.textContent = `${___WEBPACK_IMPORTED_MODULE_0__.projects[i]._name}`;
...
All tasks belonging to this project will be assigned to the Default project.`) == true) {
      let searchedProject = ___WEBPACK_IMPORTED_MODULE_0__.projects.findIndex((project) => project._name == projectName);
...
/* harmony export */   "setStorageProjects": () => (/* binding */ setStorageProjects),
