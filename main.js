...
function renderTasks(tasklist) {
  ...
  list.forEach((item) => {
    ...
    //human-readable date
    let humanDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(item.dueDate), "dd MMM");
